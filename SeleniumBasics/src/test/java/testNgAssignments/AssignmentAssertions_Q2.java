...
public class AssignmentAssertions_Q2 {
	WebDriver driver;
	...
	public void verify_Successful_Login() {
		...
		String actualresult = chooseAStoreHeading.getText();
		String expectedResult = "CHOOSE A STORE";
		Assert.assertEquals(actualresult, expectedResult, "Heading : ");
	...
	public void verify_Unsuccessful_Login_By_Invalid_Username_And_Valid_Password() {
		...
		String expectedResult = "https://qalegend.com/restaurant";
